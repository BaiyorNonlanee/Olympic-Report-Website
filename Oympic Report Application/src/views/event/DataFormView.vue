...
<template>
    ...
    class="w-full h-auto p-6 rounded relative rounded-xl rounded p-2">
        ...
        <div class="form-group mb-4 flex items-center">
          ...
          <input 
              ...
              @change="onFileChange"
              style="min-height: 120px; margin-top: 1.5%;">
        </div>
  
        <button 
            class="submit-button w-full py-2 text-white bg-red-600 rounded hover:bg-red-700 transition rounded-xl" style="margin-top: 2%;"  
            type="submit">
            Submit
        </button>
      </form>
